...
class Swin_decoder(nn.Module):
    def __init__(self, norm_layer = nn.LayerNorm):
        ...
        self.DSwinBlock1 =  nn.ModuleList([SwinTransformerBlock(dim=1024,
                                                ...
                                                norm_layer=norm_layer)
                                          for i in range(2)])
        self.DSwinBlock2 = nn.ModuleList([SwinTransformerBlock(dim=512,
                                                               ...
                                                               norm_layer=norm_layer)
                                          for i in range(4)])
        self.DSwinBlock3 = nn.ModuleList([SwinTransformerBlock(dim=256,
        ...
        self.conv256_128 = conv3x3_bn_relu(256, 128)
        self.conv256_128_ = conv3x3_bn_relu(256, 128)
        self.conv128_32 = conv3x3_bn_relu(128, 32)
        self.conv32_1 = conv3x3(32,1,1)
    def forward(self,x):
        # type(x):list
